...
from textclassify_word2vec import data_helpers, word2vec_helpers

# Parameters
# =======================================================

# Data loading parameters
from textclassify_word2vec.text_cnn import TextCNN
...
def main(_):
    ...
    for attr, value in sorted(FLAGS.__flags.items()):
        print("{}={}".format(attr, FLAGS.get_flag_value(attr, None)))
    print("")
